...
@push('css')
    <link rel="stylesheet" href="{{ asset('css/game28.css') }}" type="text/css"/>
...
@push('init-scripts')
    ...
    <script type="text/javascript" src="{{ asset('js/gamepc28.js') }}"></script>
...
@section('main')
<div onload="bwmain();"  class="main ovf bgyxzx">
        ...
        <div class="xy28_bc tzbox">
            ...
            <div class="kjdjs_box">
                ...
                <div class="yx_btn"><a href="javascript:void(0)"
                                       ...
                                       class="yxgz">游戏规则</a> <a href="/user/game/pc28v20_betting.html" class="ingame">进入游戏</a>
                </div>
            </div>
            <div class="d55445 txtScroll-top">
                <div class="hd btn"><a class="next shang" href="javascript:nextgetopencode();"></a> <a class="prev xia"
...
<div id="lightyxgz" class="white_contentyxgz">
    ...
    <div class="lyxgzcon">
        ...
        </p> <img src="/picture/yxgzimg.jpg" width="600" height="215" alt="">
