    ...
    <form id="subform" onSubmit="return checkdb(this,{{ $game_id }})">
        <div class="main ovf bgyxzx">
            <div class="w1000">
                <div class="xy28_bc">
                    <div class="titbox">
                        <div class="title">加拿大幸运28-2.8倍</div>
                        <div class="select25">
                            <select id="rid" class="mr10" name="rid" onchange="location.href='/game/canada'+$(this).val();">
                                <option selected="selected" value="v28">2.8倍场</option>
                    ...
                    <div class="sz0_27" style="margin-top:64px;">
                        <ul class="first">
                            <li><a id="tyl00" href="javascript:showbetdata('00');">00</a> <span>x12</span></li>
                            <li><a id="tyl01" href="javascript:showbetdata('01');">01</a> <span>x12</span></li>
                            <li><a id="tyl02" href="javascript:showbetdata('02');">02</a> <span>x12</span></li>
                            <li><a id="tyl03" href="javascript:showbetdata('03');">03</a> <span>x12</span></li>
                            <li><a id="tyl04" href="javascript:showbetdata('04');">04</a> <span>x12</span></li>
                            <li><a id="tyl05" href="javascript:showbetdata('05');">05</a> <span>x12</span></li>
                            <li><a id="tyl06" href="javascript:showbetdata('06');">06</a> <span>x12</span></li>
                            <li><a id="tyl07" href="javascript:showbetdata('07');">07</a> <span>x12</span></li>
                            <li><a id="tyl08" href="javascript:showbetdata('08');">08</a> <span>x12</span></li>
                            <li><a id="tyl09" href="javascript:showbetdata('09');">09</a> <span>x12</span></li>
                            <li><a id="tyl10" href="javascript:showbetdata('10');">10</a> <span>x12</span></li>
                            <li><a id="tyl11" href="javascript:showbetdata('11');">11</a> <span>x12</span></li>
                            <li><a id="tyl12" href="javascript:showbetdata('12');">12</a> <span>x12</span></li>
                            <li style="margin-right:0px;"><a id="tyl13" href="javascript:showbetdata('13');">13</a>
                                <span>x11</span>
                            </li>
                        </ul>
                        <ul class="second">
                            <li><a id="tyl14" href="javascript:showbetdata('14');">14</a> <span>x12</span></li>
                            <li><a id="tyl15" href="javascript:showbetdata('15');">15</a> <span>x12</span></li>
                            <li><a id="tyl16" href="javascript:showbetdata('16');">16</a> <span>x12</span></li>
                            <li><a id="tyl17" href="javascript:showbetdata('17');">17</a> <span>x12</span></li>
                            <li><a id="tyl18" href="javascript:showbetdata('18');">18</a> <span>x12</span></li>
                            <li><a id="tyl19" href="javascript:showbetdata('19');">19</a> <span>x12</span></li>
                            <li><a id="tyl20" href="javascript:showbetdata('20');">20</a> <span>x12</span></li>
                            <li><a id="tyl21" href="javascript:showbetdata('21');">21</a> <span>x12</span></li>
                            <li><a id="tyl22" href="javascript:showbetdata('22');">22</a> <span>x12</span></li>
                            <li><a id="tyl23" href="javascript:showbetdata('23');">23</a> <span>x12</span></li>
                            <li><a id="tyl24" href="javascript:showbetdata('24');">24</a> <span>x12</span></li>
                            <li><a id="tyl25" href="javascript:showbetdata('25');">25</a> <span>x12</span></li>
                            <li><a id="tyl26" href="javascript:showbetdata('26');">26</a> <span>x12</span></li>
                    ...
                    <table id="dx_table" style="height:46px;">
                        <tr>
                            <td id="tyl106" style="width:95px;" onclick="showbetdata('106');">大单<span>x6</span></td>
                            <td id="tyl108" style="width:95px;" onclick="showbetdata('108');">大双<span>x6</span></td>
                            <td id="tyl105" style="width:95px;" onclick="showbetdata('105');">小单<span>x6</span></td>
                            <td id="tyl107" style="width:95px;" onclick="showbetdata('107');">小双<span>x6</span></td>
                            <td id="tyl110" style="width:95px;" onclick="showbetdata('110');">极大<span>x12</span></td>
                            <td id="tyl109" style="width:95px;" onclick="showbetdata('109');">极小<span>x12</span></td>
                            ...
                            <td id="tyl140" style="width:95px;" onclick="showbetdata('140');">豹子<span>x60</span></td>
                        </tr>
                    </table>
