...
<div class="header">
    <div class="w1000">
        ...
        @else
            <div class="user" id="userpanel"><span>欢迎您，baozouxi</span><span>账户余额：<i>￥0.00</i></span><a href="/user/profile/pay.html">充值</a><a href="/user/profile/themoney.html">提现</a><a href="/user/message/index?v1">消息中心 <i>5</i></a><a href="#"  class="logout">退出</a></div>
        @endif
    </div>
</div>
<div class="nav">
