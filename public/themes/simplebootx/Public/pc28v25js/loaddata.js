...
function checkdb(the, game_id) {
    ...
    if (the.tp00) {
        if (tp100 == "") {
            tp100 = "0*" + the.tp00.value;
        } else {
            tp100 = tp100 + ",0*" + the.tp00.value;
        }
    }
    if (the.tp01) {
        if (tp100 == "") {
            tp100 = "1*" + the.tp01.value;
        } else {
            tp100 = tp100 + ",1*" + the.tp01.value;
        }
    }
    if (the.tp02) {
        if (tp100 == "") {
            tp100 = "2*" + the.tp02.value;
        } else {
            tp100 = tp100 + ",2*" + the.tp02.value;
        }
    }
    if (the.tp03) {
        if (tp100 == "") {
            tp100 = "3*" + the.tp03.value;
        } else {
            tp100 = tp100 + ",3*" + the.tp03.value;
        }
    }
    if (the.tp04) {
        if (tp100 == "") {
            tp100 = "4*" + the.tp04.value;
        } else {
            tp100 = tp100 + ",4*" + the.tp04.value;
        }
    }
    if (the.tp05) {
        if (tp100 == "") {
            tp100 = "5*" + the.tp05.value;
        } else {
            tp100 = tp100 + ",5*" + the.tp05.value;
        }
    }
    if (the.tp06) {
        if (tp100 == "") {
            tp100 = "6*" + the.tp06.value;
        } else {
            tp100 = tp100 + ",6*" + the.tp06.value;
        }
    }
    if (the.tp07) {
        if (tp100 == "") {
            tp100 = "7*" + the.tp07.value;
        } else {
            tp100 = tp100 + ",7*" + the.tp07.value;
        }
    }
    if (the.tp08) {
        if (tp100 == "") {
            tp100 = "8*" + the.tp08.value;
        } else {
            tp100 = tp100 + ",8*" + the.tp08.value;
        }
    }
    if (the.tp09) {
        if (tp100 == "") {
            tp100 = "9*" + the.tp09.value;
        } else {
            tp100 = tp100 + ",9*" + the.tp09.value;
        }
    }

    if (the.tp10) {
        if (tp100 == "") {
            tp100 = "10*" + the.tp10.value;
        } else {
            tp100 = tp100 + ",10*" + the.tp10.value;
        }
    }
    if (the.tp11) {
        if (tp100 == "") {
            tp100 = "11*" + the.tp11.value;
        } else {
            tp100 = tp100 + ",11*" + the.tp11.value;
        }
    }
    if (the.tp12) {
        if (tp100 == "") {
            tp100 = "12*" + the.tp12.value;
        } else {
            tp100 = tp100 + ",12*" + the.tp12.value;
        }
    }
    if (the.tp13) {
        if (tp100 == "") {
            tp100 = "13*" + the.tp13.value;
        } else {
            tp100 = tp100 + ",13*" + the.tp13.value;
        }
    }
    if (the.tp14) {
        if (tp100 == "") {
            tp100 = "14*" + the.tp14.value;
        } else {
            tp100 = tp100 + ",14*" + the.tp14.value;
        }
    }
    if (the.tp15) {
        if (tp100 == "") {
            tp100 = "15*" + the.tp15.value;
        } else {
            tp100 = tp100 + ",15*" + the.tp15.value;
        }
    }
    if (the.tp16) {
        if (tp100 == "") {
            tp100 = "16*" + the.tp16.value;
        } else {
            tp100 = tp100 + ",16*" + the.tp16.value;
        }
    }
    if (the.tp17) {
        if (tp100 == "") {
            tp100 = "17*" + the.tp17.value;
        } else {
            tp100 = tp100 + ",17*" + the.tp17.value;
        }
    }
    if (the.tp18) {
        if (tp100 == "") {
            tp100 = "18*" + the.tp18.value;
        } else {
            tp100 = tp100 + ",18*" + the.tp18.value;
        }
    }
    if (the.tp19) {
        if (tp100 == "") {
            tp100 = "19*" + the.tp19.value;
        } else {
            tp100 = tp100 + ",19*" + the.tp19.value;
        }
    }

    if (the.tp20) {
        if (tp100 == "") {
            tp100 = "20*" + the.tp20.value;
        } else {
            tp100 = tp100 + ",20*" + the.tp20.value;
        }
    }
    if (the.tp21) {
        if (tp100 == "") {
            tp100 = "21*" + the.tp21.value;
        } else {
            tp100 = tp100 + ",21*" + the.tp21.value;
        }
    }
    if (the.tp22) {
        if (tp100 == "") {
            tp100 = "22*" + the.tp22.value;
        } else {
            tp100 = tp100 + ",22*" + the.tp22.value;
        }
    }
    if (the.tp23) {
        if (tp100 == "") {
            tp100 = "23*" + the.tp23.value;
        } else {
            tp100 = tp100 + ",23*" + the.tp23.value;
        }
    }
    if (the.tp24) {
        if (tp100 == "") {
            tp100 = "24*" + the.tp24.value;
        } else {
            tp100 = tp100 + ",24*" + the.tp24.value;
        }
    }
    if (the.tp25) {
        if (tp100 == "") {
            tp100 = "25*" + the.tp25.value;
        } else {
            tp100 = tp100 + ",25*" + the.tp25.value;
        }
    }
    if (the.tp26) {
        if (tp100 == "") {
            tp100 = "26*" + the.tp26.value;
        } else {
            tp100 = tp100 + ",26*" + the.tp26.value;
        }
    }
    if (the.tp27) {
        if (tp100 == "") {
            tp100 = "27*" + the.tp27.value;
        } else {
            tp100 = tp100 + ",27*" + the.tp27.value;
        }
    }
    ...
    var tp142 = "";
    if (the.tp140) {
        tp140 = the.tp140.value;
    }
    if (the.tp141) {
        tp141 = the.tp141.value;
    }
    if (the.tp142) {
        tp142 = the.tp142.value;
    }

    //alert(xztf);
    //return false;
    if (tp100 == "" && tp101 == "" && tp102 == "" && tp103 == "" && tp104 == "" && tp105 == "" && tp106 == "" && tp107 == "" && tp108 == "" && tp109 == "" && tp110 == "" && tp140 == "" && tp141 == "" && tp142 == "") {
    ...
    data += "&tp140=" + encodeURIComponent($.trim(tp140));
    data += "&tp141=" + encodeURIComponent($.trim(tp141));
    data += "&tp142=" + encodeURIComponent($.trim(tp142));
...
function hidenotbet() {
    ...
    $("#tyl101").attr("onclick", "showbetdata('101');");
    $("#tyl101").removeClass("notcss");
    $("#tyl102").attr("onclick", "showbetdata('102');");
    $("#tyl102").removeClass("notcss");
    $("#tyl103").attr("onclick", "showbetdata('103');");
    $("#tyl103").removeClass("notcss");
    $("#tyl104").attr("onclick", "showbetdata('104');");
    $("#tyl104").removeClass("notcss");
    $("#tyl105").attr("onclick", "showbetdata('105');");
    $("#tyl105").removeClass("notcss");
    $("#tyl106").attr("onclick", "showbetdata('106');");
    $("#tyl106").removeClass("notcss");
    $("#tyl107").attr("onclick", "showbetdata('107');");
    $("#tyl107").removeClass("notcss");
    $("#tyl108").attr("onclick", "showbetdata('108');");
    $("#tyl108").removeClass("notcss");
    $("#tyl109").attr("onclick", "showbetdata('109');");
    $("#tyl109").removeClass("notcss");
    $("#tyl110").attr("onclick", "showbetdata('110');");
    $("#tyl110").removeClass("notcss");
...
function shownotbet() {
    $.ajax({
        ...
        success: function (dataJson) {
            if (dataJson.sign === "true") {
                /*写到这里*/
                if (dataJson.tp101 === "true") {
                    $("#tyl101").attr("onclick", "javascript:;");
                    $("#tyl101").addClass("notcss");
                }
                if (dataJson.tp102 === "true") {
                    $("#tyl102").attr("onclick", "javascript:;");
                    $("#tyl102").addClass("notcss");
                }
                if (dataJson.tp103 === "true") {
                    $("#tyl103").attr("onclick", "javascript:;");
                    $("#tyl103").addClass("notcss");
                }
                if (dataJson.tp104 === "true") {
                    $("#tyl104").attr("onclick", "javascript:;");
                    $("#tyl104").addClass("notcss");
                }
                if (dataJson.tp105 === "true") {
                    $("#tyl105").attr("onclick", "javascript:;");
                    $("#tyl105").addClass("notcss");
                }
                if (dataJson.tp106 === "true") {
                    $("#tyl106").attr("onclick", "javascript:;");
                    $("#tyl106").addClass("notcss");
                }
                if (dataJson.tp107 === "true") {
                    $("#tyl107").attr("onclick", "javascript:;");
                    $("#tyl107").addClass("notcss");
                }
                if (dataJson.tp108 === "true") {
                    $("#tyl108").attr("onclick", "javascript:;");
                    $("#tyl108").addClass("notcss");
                }
                if (dataJson.tp109 === "true") {
                    $("#tyl109").attr("onclick", "javascript:;");
                    $("#tyl109").addClass("notcss");
                }
                if (dataJson.tp110 === "true") {
                    $("#tyl110").attr("onclick", "javascript:;");
                    $("#tyl110").addClass("notcss");
                }
...
//倒计时
function loadopentime(game_id) {
    var ret = null;
    $.ajax({
        type: "get",
        url: "/game/" + game_id + "/open-time",
        data: {
            //"act": "get"
        },
        dataType: "json",
    ...
    if (ret) {
        ...
        $("#lottshow1").hide();
        $("#lottshow2").show();
        loadOpenCode(game_id, ret);
    }
}

//近10期开奖结果
function getBetsListCircle(game_id) {
    $.ajax({
        url: "/game/" + game_id + "/last-open-codes-list",
        type: "get",
        data: {
            //"expect": expect
        },
...
//最近10结果
function get_expect_list_10(game_id) {
    $.ajax({
        // url: "/user/game/load_open_list_10/t/"+Math.random(),
        url: "/game/" + game_id + "/last10",
        dataType: "json",
        ache: false,
        async: false,
        success: function (dataJson) {
...
function getOpenCodeList(key) {
    var json_list = eval(expect_list_10);
...
function loadOpenCode(game_id, expect) {
    clearTimeout(opencodeTimeOut);
    $.ajax({
        url: "/game/" + game_id + "/last-open-codes/" + expect,
        // url: "/user/game/load_open_code/expect/"+expect+"/t/"+Math.random(),
        type: "get",
        data: {
            //"expect": expect
        },
...
function countdownTime(qihao, num, timeHD, game_id) {
